...
```gradle
dependencies {
    implementation 'com.github.apiverve:textsummarizer-api:1.1.12'
}
```
...
```java
import com.apiverve.textsummarizer.TextSummarizerAPIClient;
import com.apiverve.textsummarizer.APIResponse;
import com.apiverve.textsummarizer.APIException;

// Initialize the client
TextSummarizerAPIClient client = new TextSummarizerAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/textsummarizer](https://docs.apiverve.com/ref/textsummarizer)
...
- **Documentation:** [https://docs.apiverve.com/ref/textsummarizer](https://docs.apiverve.com/ref/textsummarizer)
- **Issues:** [GitHub Issues](https://github.com/apiverve/textsummarizer-api/issues)
