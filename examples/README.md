# Text Summarizer API - Examples

This folder contains example code for using the Text Summarizer API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/textsummarizer',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/textsummarizer");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/textsummarizer](https://docs.apiverve.com/ref/textsummarizer)
